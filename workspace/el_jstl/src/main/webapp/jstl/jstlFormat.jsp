...
<fmt:formatNumber type="number" maxFractionDigits="1">123456789.88</fmt:formatNumber><br>
<br>
...
<fmt:formatNumber type="number" value="0000.00" pattern="0,000.00"></fmt:formatNumber><br> <!-- 강제로 0을 표시 -->
...
<fmt:formatDate value="${now}" pattern="HH-mm-ss" type="time"/><br> <!-- HH > 24 -->
